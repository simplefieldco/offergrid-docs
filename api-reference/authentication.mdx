...
uri = URI('https://offergrid-api.onrender.com/provider/offers')
...
func main() {
    client := &http.Client{}
    req, _ := http.NewRequest("GET", "https://offergrid-api.onrender.com/provider/offers", nil)
...
$ch = curl_init('https://offergrid-api.onrender.com/provider/offers');
