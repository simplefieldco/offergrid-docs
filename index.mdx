...
OfferGrid is a B2B marketplace platform that streamlines the distribution and sale of essential services. We connect service providers (offering internet, TV, security, energy, and insurance) with reseller partners who help customers find and purchase these services.
...
- Create exclusive offers for top performers
...
- Filter by ZIP code to show available services
...
**Earn Commissions**
- Get paid for successful activations
- Recurring revenue on active services
- Volume bonuses for high performers
...
<Steps>
  ...
  <Step title="Orders placed">
    Resellers submit orders with customer information and service addresses
  </Step>

  <Step title="Providers fulfill">
    Providers accept orders, schedule installations, and activate services
  </Step>

  <Step title="Everyone wins">
    Customers get services, providers expand reach, resellers earn commissions
  </Step>
</Steps>
