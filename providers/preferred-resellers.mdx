...
```bash
curl -X POST "https://offergrid-api.onrender.com/provider/partners/preferred" \
...
curl -X DELETE "https://offergrid-api.onrender.com/provider/partners/preferred/team-abc-123" \
  -H "x-api-key: YOUR_API_KEY"
```
